...
async function seedRouteRole () {
  try {
    const routeRoles = [ 
      ...
      {
        route: '/admin/test_01/create',
        role: 'SYSTEM_USER',
        method: 'POST' 
      },
      {
        route: '/admin/test_01/list',
        role: 'SYSTEM_USER',
        method: 'POST' 
      },
      {
        route: '/admin/test_01/aggregate',
        role: 'SYSTEM_USER',
        method: 'POST'
      },
      {
        route: '/admin/test_01/:id',
        role: 'SYSTEM_USER',
        method: 'GET' 
      },
      {
        route: '/admin/test_01/count',
        role: 'SYSTEM_USER',
        method: 'POST' 
      },
      {
        route: '/admin/test_01/update/:id',
        role: 'SYSTEM_USER',
        method: 'PUT'
      },
      {
        route: '/admin/test_01/partial-update/:id',
        role: 'SYSTEM_USER',
        method: 'PUT'
      },
      {
        route: '/admin/test_01/softdelete/:id',
        role: 'SYSTEM_USER',
        method: 'PUT'
      },
      {
        route: '/admin/test_01/softdeletemany',
        role: 'SYSTEM_USER',
        method: 'PUT'
      },
      {
        route: '/admin/test_01/delete/:id',
        role: 'SYSTEM_USER',
        method: 'DELETE'
      },
      {
        route: '/admin/test_01/deletemany',
        role: 'SYSTEM_USER',
        method: 'DELETE'
      },
      {
        route: '/admin/test_01/addbulk',
        role: 'SYSTEM_USER',
        method: 'POST'
      },
      {
        route: '/admin/test_01/updatebulk',
        role: 'SYSTEM_USER',
        method: 'PUT'
      },
      {
      ...
      {
        route: '/device/api/v1/test_01/create',
        role: 'SYSTEM_USER',
        method: 'POST'
      },
      {
        route: '/device/api/v1/test_01/list',
        role: 'SYSTEM_USER',
        method: 'POST'
      },
      {
        route: '/device/api/v1/test_01/aggregate',
        role: 'SYSTEM_USER',
        method: 'POST'
      },
      {
        route: '/device/api/v1/test_01/:id',
        role: 'SYSTEM_USER',
        method: 'GET'
      },
      {
        route: '/device/api/v1/test_01/count',
        role: 'SYSTEM_USER',
        method: 'POST'
      },
      {
        route: '/device/api/v1/test_01/update/:id',
        role: 'SYSTEM_USER',
        method: 'PUT'
      },
      {
        route: '/device/api/v1/test_01/partial-update/:id',
        role: 'SYSTEM_USER',
        method: 'PUT'
      },
      {
        route: '/device/api/v1/test_01/softdelete/:id',
        role: 'SYSTEM_USER',
        method: 'PUT'
      },
      {
        route: '/device/api/v1/test_01/softdeletemany',
        role: 'SYSTEM_USER',
        method: 'PUT'
      },
      {
        route: '/device/api/v1/test_01/delete/:id',
        role: 'SYSTEM_USER',
        method: 'DELETE'
      },
      {
        route: '/device/api/v1/test_01/deletemany',
        role: 'SYSTEM_USER',
        method: 'DELETE'
      },
      {
        route: '/device/api/v1/test_01/addbulk',
        role: 'SYSTEM_USER',
        method: 'POST'
      },
      {
        route: '/device/api/v1/test_01/updatebulk',
        role: 'SYSTEM_USER',
        method: 'PUT'
      },
      {
...
async function seedUserRole (){
  try {
    let user = await User.findOne({
      'email':'Gabriel.Kirlin9@hotmail.com',
      'isActive':true,
      'isDeleted':false
    });
    let userRole = await Role.findOne({ code: 'SYSTEM_USER' }, { id: 1 });
    if (user && user.isPasswordMatch('X5sP7VGVAwGu_BE') && userRole){
    ...
    let admin = await User.findOne({
      'email':'Ethan.Borer@yahoo.com',
      'isActive':true,
      'isDeleted':false
    });
    let adminRole = await Role.findOne({ code: 'SYSTEM_USER' }, { id: 1 });
    if (admin && admin.isPasswordMatch('nUZBMNEZxLLGfQR') && adminRole){
      let count = await UserRole.countDocuments({
        userId: admin.id,
        roleId: adminRole.id,
        isActive: true, 
...
async function seedUser () {
  try {
    ...
    if (!user || !user.isPasswordMatch('X5sP7VGVAwGu_BE') ) {
      let user = new User({
        'password':'X5sP7VGVAwGu_BE',
        'email':'Gabriel.Kirlin9@hotmail.com',
    ...
    if (!admin || !admin.isPasswordMatch('nUZBMNEZxLLGfQR') ) {
      let admin = new User({
        'password':'nUZBMNEZxLLGfQR',
        'email':'Ethan.Borer@yahoo.com',
