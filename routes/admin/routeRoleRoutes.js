...
router.route('/admin/routerole/softDeleteMany').put(auth(...[ 'softDeleteManyByAdminInAdminPlatform' ]),routeRoleController.softDeleteManyRouteRole);
router.route('/admin/routerole/deleteMany').delete(auth(...[ 'deleteManyByAdminInAdminPlatform' ]),routeRoleController.deleteManyRouteRole);
...
router.route('/admin/routerole/delete/:id').delete(auth(...[ 'deleteByAdminInAdminPlatform' ]),routeRoleController.deleteRouteRole);
