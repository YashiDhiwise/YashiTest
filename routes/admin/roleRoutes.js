...
router.route('/admin/role/softDeleteMany').put(auth(...[ 'softDeleteManyByAdminInAdminPlatform' ]),roleController.softDeleteManyRole);
router.route('/admin/role/deleteMany').delete(auth(...[ 'deleteManyByAdminInAdminPlatform' ]),roleController.deleteManyRole);
...
router.route('/admin/role/delete/:id').delete(auth(...[ 'deleteByAdminInAdminPlatform' ]),roleController.deleteRole);
