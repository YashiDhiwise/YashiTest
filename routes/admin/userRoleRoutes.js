...
router.route('/admin/userrole/softDeleteMany').put(auth(...[ 'softDeleteManyByAdminInAdminPlatform' ]),userRoleController.softDeleteManyUserRole);
router.route('/admin/userrole/deleteMany').delete(auth(...[ 'deleteManyByAdminInAdminPlatform' ]),userRoleController.deleteManyUserRole);
...
router.route('/admin/userrole/delete/:id').delete(auth(...[ 'deleteByAdminInAdminPlatform' ]),userRoleController.deleteUserRole);
