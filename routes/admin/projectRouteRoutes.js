...
router.route('/admin/projectroute/softDeleteMany').put(auth(...[ 'softDeleteManyByAdminInAdminPlatform' ]),projectRouteController.softDeleteManyProjectRoute);
router.route('/admin/projectroute/deleteMany').delete(auth(...[ 'deleteManyByAdminInAdminPlatform' ]),projectRouteController.deleteManyProjectRoute);
...
router.route('/admin/projectroute/delete/:id').delete(auth(...[ 'deleteByAdminInAdminPlatform' ]),projectRouteController.deleteProjectRoute);
