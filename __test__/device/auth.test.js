...
beforeAll(async function (){
  try {
    ...
    inserted_user = await user.insertOne({
      username: 'Modesto_Mohr',
      password: 'AhMzMlm_bRjiUDY',
      email: 'Rosendo.Pacocha@gmail.com',
      name: 'Dale Predovic',
      role: 830,
      resetPasswordLink: {},
      loginRetryLimit: 641,
      loginReactiveTime: '2022-06-03T15:08:45.243Z',
      id: '618deda635e5d803d5435319'
    });
  }
  catch (err) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Tyree.Nicolas',
        'password':'d42FLtWYNi2zTgf',
        'email':'Mossie49@yahoo.com',
        'name':'Sean Schmeler',
